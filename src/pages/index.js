        ...
        >
          <nav className="py-10 mb-5 flex justify-around">
            ...
            <ul className="flex items-center gap-5">
              ...
              <li>
                <a
                  href="https://drive.google.com/file/d/11WPWSEwGzIv3z4M-RuWgJxBHc2TWmZtw/view?usp=share_link"
                  target="_blank"
          ...
          shadow-xl mb-5"
            ...
            <p className="text-sm py-2 dark:text-gray-200 max-w-[1000px] text-center mx-auto">
              ...
              all my time and energy in this new field of expertise. My purpose
              is to work as a full-time web developer and keep on progressing
              with experience.
            </p>
          </div>
